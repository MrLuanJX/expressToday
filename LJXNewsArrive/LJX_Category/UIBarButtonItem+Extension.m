...
//    btn.size = btn.currentImage.size;
    btn.size = CGSizeMake(btn.currentImage.size.width + NAFit(10), btn.currentImage.size.height + NAFit(10));
    btn.imageEdgeInsets = UIEdgeInsetsMake(0, -NAFit(10), 0, 0);
...
+ (UIBarButtonItem *)itemWithTarget:(id)target action:(SEL)action Title:(NSString *)title TitleColor:(UIColor *)titleColor{
    ...
    btn.titleLabel.font = NAFontSize(16);
    [btn sizeToFit];
